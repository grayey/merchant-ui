...
## Table of Contents
   ...
   * [Fury - Angular 11+ Material Design Admin Template](#fury---angular-6+-material-design-admin-template)
...
| `src`                 | Contains all Angular 11+ Typescript code, assets and basically everything the end user will have access to. |
...
Now that we have installed all prerequisites it's time to start developing our app. Angular-CLI offers a lot of assistance and allows you to generate basically all Angular 11+-Components there are. *(In a smart way!)*
...
* [RxJS](//github.com/ReactiveX/rxjs) - Angular 11+ Dependency - A new approach to how data can be handled in Observables.
