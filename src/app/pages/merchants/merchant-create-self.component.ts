...
@Component({
  selector: 'fury-merchant-create-self',
  templateUrl: './merchant-create-self.component.html',
  styleUrls: ['./merchant-create-self.component.scss']
})
export class MerchantCreateSelfComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              ...
              @Inject(MAT_DIALOG_DATA) public onBoardedMerchant?: any, private dialogRef?: MatDialogRef<MerchantCreateSelfComponent>,) {
                this.merchantDetailsForm = this.fb.group(MerchantCreateSelfComponent.merchantDetailsForm())
                this.merchantContactForm = this.fb.group(MerchantCreateSelfComponent.merchantContactForm())
                this.OTPForm = this.fb.group(MerchantCreateSelfComponent.OTPForm());
                this.previewForm = this.fb.group(MerchantCreateSelfComponent.previewForm());
                this.authenticationForm = this.fb.group(MerchantCreateSelfComponent.authenticationForm());
                this.feeSetUpForm = this.fb.group(MerchantCreateSelfComponent.feeSetUpForm());
            
                this.merchantUserForm = this.fb.group(MerchantCreateSelfComponent.merchantUserForm());
                this.encryptionForm = this.fb.group(MerchantCreateSelfComponent.encryptionForm());
                this.previewData = {};
